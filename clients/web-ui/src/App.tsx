...
import {
  Badge, Button, Chip, CopyButton, Empty, ErrorBanner, Field, Input, Modal, Select, SelectItem,
  ...
  return (
    <div style={{ display: 'grid', placeItems: 'center', minHeight: '100dvh', padding: '1rem' }}>
      <form onSubmit={submit} className="card" style={{ padding: '1.5rem', width: '100%', maxWidth: 480 }}>
        ...
        <Button variant="primary" type="submit" disabled={!value.trim() || busy} style={{ width: '100%', justifyContent: 'center' }}>
      ...
      {result && (
        <>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', fontSize: '0.82rem', flexWrap: 'wrap' }}>
            ...
            <Button onClick={() => setExplain((v) => !v)} style={{ padding: '0.15rem 0.5rem', fontSize: '0.75rem' }}>
