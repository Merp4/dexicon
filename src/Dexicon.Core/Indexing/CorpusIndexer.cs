    ...
    ILogger<CorpusIndexer> log)
{
    ...
    ///
    /// The enumeration is the inventory and is deliberately cheap: shas, dates and
    /// subjects, no bodies. Which of them still need reading is then settled against the
